...
<body>
    ...
    <div class="page-header">
        ...
        <form method="GET" action="https://localhost/site/page.php?cv=&">
...
<div class="container-fluid mt-4">
    <div class="row g-3 d-flex flex-wrap justify-content-center">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/site/trocador.php" class="btn btn-outline-primary btn-xl w-100">Declaração do Serviço #1</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/site/trocadorpagamento.php" class="btn btn-outline-secondary btn-xl w-100">Controle de Informações #2</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="meusequipamentos.php" class="btn btn-outline-info btn-xl w-100">Comunicação Externa #3!</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/site5/" class="btn btn-outline-dark btn-xl w-100">Central de Prestações #4!</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/site/consultar_vooreserva.php" class="btn btn-outline-success btn-xl w-100">Consultar Reserva de Voo</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/site/todas_reservas_voo.php" class="btn btn-outline-secondary btn-xl w-100">Ver Todas Reservas de Voos</a>
        </div>
    </div>
    ...
    <div class="row g-3 d-flex flex-wrap justify-content-center">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/reservadoquarto.php" class="btn btn-info btn-xl w-100">Reserva Quartos</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="https://localhost/site/destacar.php" class="btn btn-primary btn-xl w-100">Destacar</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="reset-password.php" class="btn btn-warning btn-xl w-100">Alterar senha</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-center">
            <a href="logout.php" class="btn btn-danger btn-xl w-100">Sair</a>
        </div>
    </div>
</div>
